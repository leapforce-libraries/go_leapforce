...
func ValidatePhoneEncrypt(portalId string, objectType string, objectId string, phoneNumber string, region string, targetField string, cipherKey string) (string, *errortools.Error) {
